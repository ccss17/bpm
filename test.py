...
def test_insert_lyrics(midi_obj, target_track_list=None):
    ...
    lyric = """J' '다정했던사람이여나를잊었나' '벌써나를' '잊어버렸나' '그리움만남겨놓고나를잊었나' '벌써나를잊어버렸나' '그대지금그누구를사랑하는가' '굳은약속' '변해버렸나' '예전에는우린서로사랑' '했는데' '이젠맘이변해버렸나' '아이별이' '그리쉬운가' '세월가버렸다고' '이젠나를잊고서멀리' '멀리떠나가는가' '아아나는몰랐네' '그대마음변할주우울' '난정말몰랐었네' '오나너하나만으을' '믿고살았네에에에' ' 그대만으을믿었네' '오네가보고파서어' '나는어쩌나아아' '그리우움만쌓이네' '아이 별이' '그리쉬운가' '세월가버렸다고' '이젠나를잊고서' '멀리' '멀리떠나가는가' ' 아아나는몰랐네' '그대마음변할주우울' '난정말몰랐었네' '오오오난너하나만으을' ' 믿고살았네에에' '그대만으을믿었네' '오네가아' '보고파서어나는어쩌나아아' '그리 우움만쌓이네' 'H"""
...
if __name__ == "__main__":
    ...
    test_trim_slice_midi(samples[2]["wav"], samples[2]["mid"])
